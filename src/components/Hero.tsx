  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16" style={{ paddingBottom: '8px' }}>
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
        ...
        <h1 
          className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-space-md opacity-0 animate-fade-in" 
          style={{ 
            lineHeight: '1.2', 
            margin: 0, 
        ...
        <div 
          className="flex justify-center mb-space-lg opacity-0 animate-slide-down" 
          style={{ 
            margin: 0, 
        ...
        <h2 
          className="text-xl sm:text-2xl md:text-3xl font-semibold text-foreground mb-space-md opacity-0 animate-slide-down" 
          style={{ 
            lineHeight: '1.2', 
            margin: 0, 
            marginBottom: 'var(--space-md)',
